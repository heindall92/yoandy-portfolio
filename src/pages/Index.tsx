  ...
  return (
    <div className={`draft-page ${theme}`} lang={language}>
      <style>{`
        ...
        .theme-switch .ts-bubble{position:absolute;top:2px;left:2px;width:36px;height:26px;border-radius:999px;background:linear-gradient(180deg,rgba(0,232,122,.40) 0%,rgba(0,232,122,.12) 100%);backdrop-filter:blur(10px) saturate(140%);-webkit-backdrop-filter:blur(10px) saturate(140%);border:1px solid rgba(0,232,122,.45);box-shadow:0 4px 14px rgba(0,0,0,.45),inset 0 1px 1px rgba(0,232,122,.35),inset 0 -2px 4px rgba(0,0,0,.18);display:flex;align-items:center;justify-content:center;color:#00e87a;transition:transform .55s cubic-bezier(.34,1.56,.64,1),background .4s ease,color .4s ease,box-shadow .4s ease;z-index:2}
        ...
        .theme-switch.is-light{background:#d4f0e0;color:rgba(6,40,22,.65);border-color:rgba(10,143,85,.18);box-shadow:inset 0 1px 2px rgba(255,255,255,.85),inset 0 -2px 6px rgba(0,0,0,.06),0 6px 14px rgba(0,0,0,.10)}
        .theme-switch.is-light .ts-bubble{color:#06582e;background:linear-gradient(180deg,rgba(255,255,255,.85) 0%,rgba(255,255,255,.45) 100%);border-color:rgba(0,232,122,.55);box-shadow:0 4px 12px rgba(0,0,0,.12),inset 0 1px 1px rgba(255,255,255,.95),inset 0 -2px 4px rgba(0,0,0,.04)}
