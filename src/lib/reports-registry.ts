...
export const reports: Record<string, ReportEntry> = {
  ...
  "kobold-htb": { title: "Writeup — Kobold (HTB)", file: "/reports/kobold-htb.html", section: "htb" },
  "variatype-htb": { title: "Writeup — VariaType (HTB)", file: "/reports/variatype-htb.html", section: "htb" },
  ...
  "logging-htb": { title: "Writeup — Logging (HTB)", file: "/reports/logging-htb.html", section: "htb" },
};
