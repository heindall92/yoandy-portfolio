...
export const projects: ProjectEntry[] = [
  {
    ...
    description: [
      "Valhalla SOC es una plataforma Blue/Purple Team operativa 24/7: una infraestructura productiva expuesta a Internet mediante un honeypot Cowrie que captura bots y atacantes reales, registra cada tecla y cada comando, y reenvía los logs a un SIEM Wazuh que los clasifica con 12+ reglas custom mapeadas a MITRE ATT&CK. No es un laboratorio: es un SOC funcional con telemetría real, triage automático y reporting ejecutable.",
